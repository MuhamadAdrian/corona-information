    ...
    <div>
        ...
        <v-row>
            <v-col cols="12" class="pb-sm-2 py-1">
                ...
                type="list-item-two-line"
                >
                <v-card class="mb-0 my-shadow3" flat>
        ...
        <v-row>
            <v-col cols="12" class="pr-sm-2 pr-1 pb-sm-2 py-1">
                <v-skeleton-loader
                :loading="loading"
                :transition="transition"
                height="75"
                ...
                <v-card class="mb-0 my-shadow3" flat>
                    <v-card-text class="text-center">
                        <h5 class="mb-3">Meniggal Hari Ini<v-icon right>mdi-calendar-today</v-icon></h5>
                        <h1>{{ singleData.todayDeaths | numFormat }}</h1>
                    </v-card-text>
                </v-card>
                </v-skeleton-loader>
            </v-col>
